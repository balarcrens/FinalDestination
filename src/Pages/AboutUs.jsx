        ...
        <section>
            ...
            <div className="py-16 border-t border-gray-200 dark:border-gray-700">
                <div className="max-w-6xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        <div className="bg-blue-50 rounded-xl p-6 text-center shadow hover:shadow-lg transition">
            ...
            <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-16">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        { name: "Dhameliya Hit", role: "Founder & CEO", phone: "+91 9638601192", email: "heetdhameliya@gmail.com" },
                        { name: "Dhanani Harsh", role: "Co-Founder & CEO", phone: "+91 8905718200", email: "harshdhanani@gmail.com" }
                    ].map((member, idx) => {
                        const show = active === idx;
                        return (
                            <div
                                key={idx}
                                className="relative shadow-lg rounded-xl p-6 text-center border border-gray-400 hover:shadow-xl transition-all duration-300 hover:scale-102 overflow-hidden group cursor-pointer"
            ...
            <div className="relative overflow-hidden rounded-xl shadow-lg">
                ...
                <div className="relative z-10 py-16 px-6 text-center text-white max-w-4xl mx-auto">
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 drop-shadow-md">
                        Let’s Create Memories That Last Forever
                    </h3>
                    <p className="mb-8 text-base sm:text-md md:text-lg opacity-95 max-w-2xl mx-auto">
