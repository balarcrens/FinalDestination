        ...
        <>
            ...
            >
                ...
                <nav className="hidden md:flex space-x-5 font-medium">
                    ...
                    <Link to="/bookings" className="hover:underline hover:text-[#144565] transition-all duration-300 underline-offset-4">
                        Booking
                    </Link>
            ...
            {menuOpen && (
                <div className="md:hidden bg-white backdrop-blur-md p-6 space-y-4 animate-slideDown">
                    ...
                    <Link to="/booking" className="block hover:underline underline-offset-4" onClick={() => setMenuOpen(false)}>Booking</Link>
